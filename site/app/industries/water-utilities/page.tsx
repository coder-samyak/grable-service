...
export default function Page() {
  return (
    <PageShell
      ...
      template="standard"
      backgroundImage="/images/water-utilites1.png"
      processBackgroundImage="/images/water-utilites2.png"
      splitBackgroundImage="/images/water-utilities3.png"
      stepsBackgroundImage="/images/water-utilites4.png"
      cards={[
        {
